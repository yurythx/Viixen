...
export default function DeleteArticleButton({ slug, className = '' }: DeleteArticleButtonProps) {
  ...
  return (
    <>
      <button
        ...
        className={`text-red-600 hover:text-red-800 focus:outline-none ${className}`}
