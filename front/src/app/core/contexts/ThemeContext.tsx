...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    console.log('Aplicando cor do tema:', themeColor);
    ...
    // Verificar se a classe foi adicionada corretamente
    console.log('Classes após adição:', root.classList.toString());

    // Salvar no localStorage
    localStorage.setItem('themeColor', themeColor);

    // Definir variáveis CSS para cores do tema
    console.log('Definindo variáveis CSS para cor:', themeColor);
    ...
    console.log('Variáveis CSS definidas:', {
      ...
      primaryHover: getComputedStyle(root).getPropertyValue('--primary-hover'),
      primaryColorRgb: getComputedStyle(root).getPropertyValue('--primary-color-rgb')
    });
  }, [themeColor]);
